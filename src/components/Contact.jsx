const socialLinks = [
  {
    href: "https://www.github.com/simsidhu7",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/simrit-sidhu",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  return (
    <section className="section" id="contact">
      <div className="container">
        <div className="">
          <h2 className="headline-2">Let's connect!</h2>

          <p className="text-zinc-400 mt-2 mb-2 reveal-up">
            Reach out to discuss working together! Contact me:
            <a
              href="mailto:simritsidhu1@gmail.com"
              className="text-blue-500 underline"
            >
              simritsidhu1@gmail.com
            </a>{" "}
